        ...
        <div className="flex items-center sm:justify-between sm:gap-4">
          ...
          <div className="flex flex-1 items-center justify-between gap-8 sm:justify-end">
            <div className="flex gap-4">
              ...
              <button
                className={`block shrink-0 rounded-lg p-2.5 text-gray-600 shadow-sm hover:text-gray-700 ${isDarkMode ? "bg-teal-600" : "bg-white"
              }`}
              >
...
{(unreadCount > 11) && (
              ...
              <button
                className={`block shrink-0 rounded-lg p-2.5 text-gray-600 shadow-sm hover:text-gray-700 ${!isDarkMode ? "bg-gray-700" : "bg-yellow-400"
              }`}
