      ...
      >
        ...
        <div className="mt-2">
          <div className="mb-2 flex justify-center">
            <strong>
            For: <p className="text-base text-gray-500">{product.speciality}</p></strong>
          </div>
          <div className="mb-2 flex justify-center gap-1">
          <strong><p className="text-base text-gray-50 rounded-full p-2 bg-gray-500">BRL {product.costBRL}</p></strong>
          <strong><p className="text-base text-gray-50 rounded-full p-2 bg-gray-500">{product.stock} items</p></strong>
            <strong><p className="text-base text-gray-50 rounded-full p-2 bg-gray-500">$ {product.price}</p></strong>
